...
int simRound(int &gains) {
    ...
    const int TRIALS = 2000; //TODO: set to 500
...
int main(int argc, char **argv) {
    ...
    if(cardsOnTable == 0) { // get Bet
        ...
        switch(dec){
            case 0: std::cout << "stand"; break;
            case 1: std::cout << "hit"; break;
            case 2: std::cout << "double"; break;
            case 3: std::cout << "split"; break;
            case 4: std::cout << "surrender"; break;
        }
    }
